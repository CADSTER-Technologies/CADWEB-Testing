        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          >
            <div className="w-10 h-10 rounded-lg flex items-center justify-center">
              <span className="text-white font-orbitron font-bold text-xl"><img src="/logo/cadster_logo.png" alt="Cadster Logo" className="w-12 h-12 object-contain" /></span>
            </div>

            <span className="hidden sm:block font-orbitron font-bold text-2xl
