  ...
  return (
    <group ref={groupRef}>
      ...
      <points ref={particlesRef} geometry={particles}>
        <pointsMaterial size={0.02} color="#00E1FF" transparent opacity={0.6} />
      </points>

      {[...Array(6)].map((_, i) => (
        <mesh key={i} rotation={[0, (i * Math.PI) / 3, 0]}>
          <torusGeometry args={[2, 0.01, 16, 100]} />
          <meshBasicMaterial color="#7A00FF" transparent opacity={0.4} />
        </mesh>
      ))}
    </group>
  );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl font-inter text-white/80 mb-6 leading-relaxed">
              Founded in 2023, Cadster Technologies stands at the forefront of CAD/PLM automation 
            ...
            <p className="text-lg md:text-xl font-inter text-white/80 mb-6 leading-relaxed">
              ...
              and cutting-edge AR/VR solutions. We empower engineering teams to push boundaries 
